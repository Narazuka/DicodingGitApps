...
import com.dicoding.mysubmissionfd1.ui.detail_model.FollowingViewModel

class FollowingFragment: Fragment(R.layout.followers_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getUsernameFollowing().observe(viewLifecycleOwner) {
            if (it != null) {
                adapter.setList(it)
                showLoading(false)
            }
